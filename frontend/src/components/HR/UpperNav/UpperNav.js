...
import userImage from "../../../assets/superadmin/userIcon.jpg";
          ...
          <div className='w-[30%] flex gap-[1rem] items-center pr-[1rem]'>
            ...
            {showProfileDropdown && (
              <div className='absolute px-[3rem] top-[5rem] flex flex-col items-center z-10 fade-in'>
                ...
                <div className='bg-[#3497F9] px-[4rem] shadow-md py-[2rem] rounded-md'>
                  <Logout Style='bg-[#202020] text-white p-[4px] rounded-md' />
                </div>
              </div>
            )}
          </div>
