...
function IpdPatientReciptChargesShowcase({
  ...
  return (
    <>
      {responseIpdPatientMedDocLabDetailCall && medDocLabChargesTotal ? (
        <div>
          ...
          <div className="flex flex-col justify-start items-start mb-8">
            ...
            <table className="w-full table-auto border-spacing-2 text-[#595959] font-[300]">
              ...
              <tbody className="text-gray-500 font-semibold">
                {responseIpdPatientMedDocLabDetailCall.map(
                  (entry, entryIndex) =>
                ...
                <tr>
                  ...
                  >
                    Rs.{" "}
                    {medDocLabChargesTotal?.overallTotalMedicinePrice?.toFixed(
                      2
                    )}
                  </td>
                </tr>
            ...
            <table className="w-full table-auto border-spacing-2 text-[#595959] font-[300]">
              ...
              <tbody className="text-gray-500 font-semibold">
                ...
                <tr>
                  ...
                  >
                    Rs.{" "}
                    {medDocLabChargesTotal?.overallTotalTestPrice?.toFixed(2)}
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table className="w-full table-auto border-spacing-2 text-[#595959] font-[300]">
              ...
              <tbody className="text-gray-500 font-semibold">
                ...
                <tr>
                  ...
                  >
                    Rs.{" "}
                    {medDocLabChargesTotal?.overallDoctorVisitCharge?.toFixed(
                      2
                    )}
                  </td>
                </tr>
